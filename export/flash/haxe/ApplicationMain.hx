...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("gamedev_project1", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("gamedev_project1", null, 640, 480);
		#end
		#else
		create (null);
		#end
		...
		var projectName = "gamedev_project1";
		
		var config = {
			
			build: "1",
			company: "HaxeFlixel",
			file: "gamedev_project1",
			fps: 60,
			name: "gamedev_project1",
			orientation: "",
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "gamedev_project1";
		app.meta["name"] = "gamedev_project1";
